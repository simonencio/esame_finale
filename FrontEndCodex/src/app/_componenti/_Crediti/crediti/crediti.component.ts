...
@Component({
  selector: 'crediti', // Kept the selector unchanged
  templateUrl: './crediti.component.html', // Kept the template URL unchanged
  styleUrls: ['./crediti.component.scss'] // Kept the style URL unchanged
})
