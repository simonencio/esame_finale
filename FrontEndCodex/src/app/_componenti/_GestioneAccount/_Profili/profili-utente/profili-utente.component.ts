...
@Component({
  selector: 'profili-utente', // Kept the selector unchanged
  templateUrl: './profili-utente.component.html', // Kept the template URL unchanged
  styleUrls: ['./profili-utente.component.scss'] // Kept the style URL unchanged
})
