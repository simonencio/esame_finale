...
@Component({
  selector: 'recapiti-utente', // Kept the selector unchanged
  templateUrl: './recapiti-utente.component.html', // Kept the template URL unchanged
  styleUrls: ['./recapiti-utente.component.scss'] // Kept the style URL unchanged
})
