...
@Component({
  selector: 'Indirizzi', // Kept the selector unchanged
  templateUrl: './Indirizzi.component.html', // Kept the template URL unchanged
  styleUrls: ['./Indirizzi.component.scss'] // Kept the style URL unchanged
})
